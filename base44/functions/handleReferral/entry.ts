...
Deno.serve(async (req) => {
  try {
    ...
    const REFERRAL_POINTS = settingsList[0]?.referral_points || 50;
    ...
    if (referrerProfiles[0]) {
      ...
      await base44.asServiceRole.entities.Notification.create({
        ...
        message_es: `¡Tu amigo ${new_user_email} hizo su primer pedido! Ganaste ${REFERRAL_POINTS} puntos 🍓`,
        message_en: `Your friend ${new_user_email} placed their first order! You earned ${REFERRAL_POINTS} points 🍓`,
        type: 'loyalty',
        link: '/referral',
      });
    }
    ...
    await base44.asServiceRole.integrations.Core.SendEmail({
      to: referrer_email,
      subject: `🍓 ¡Ganaste ${REFERRAL_POINTS} puntos por referir un amigo!`,
      body: `
        <div style="font-family: Arial, sans-serif; max-width: 500px; margin: 0 auto;">
          ...
          <div style="padding: 24px; text-align: center;">
            ...
            <p style="color: #666;">Tu amigo hizo su primer pedido usando tu código de referido.</p>
    ...
    return Response.json({ success: true, points_awarded: REFERRAL_POINTS });
  } catch (error) {
