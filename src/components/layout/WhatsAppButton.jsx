...
export default function WhatsAppButton({ phone = '525512345678' }) {
  const url = `https://wa.me/${phone}?text=Hola%20Fresitas%20G%26F%2C%20quiero%20hacer%20un%20pedido%20%F0%9F%8D%93`;
